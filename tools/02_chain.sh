...
# bash 2ysbOFE.sh 2.2.5 1.5.2

#org1
rm -r multiple-deployment-org1
mkdir multiple-deployment-org1
cd multiple-deployment-org1
...
cp ../docker-compose-up_org1.yaml .
docker-compose -f ./docker-compose-up_org1.yaml up -d


#org2
cd ~/02_meta/workspace
rm -r multiple-deployment-org2
mkdir multiple-deployment-org2
cd multiple-deployment-org2

cp ../multiple-deployment-org1/channel-artifacts -r .
cp ../multiple-deployment-org1/crypto-config -r .

cp ../docker-compose-up_org2.yaml .
